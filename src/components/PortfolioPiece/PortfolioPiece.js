...
import classes from './PortfolioPiece.scss';

const portfolioPiece = props => {
  return (
    <div class="row showcase-2">
      <div class="small-12 large-5 large-push-7 columns" data-aos="fade-up" data-aos-delay="100">
        ...
        <a class="cta project-cta" href="https://www.pcfinancial.ca/en/campaign/new-digital-experience" target="_blank"
          rel="noopener noreferrer" title="PC Financial, New Digital Experience. View the project.">View the project</a>
      </div>
      <div class="small-12 large-7 large-pull-5 columns end" data-aos="fade-up" data-aos-delay="100">
        <a href="https://www.pcfinancial.ca/en/campaign/new-digital-experience" target="_blank" rel="noopener noreferrer"
          ...
          <div class="showcase-example margin-top-0-mobile-margin-top-2">
