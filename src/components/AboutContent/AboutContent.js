...
const aboutContent = props => {
  return (
    <React.Fragment>
      ...
      <Row>
        <Column className={classes.Experience} small={12}>
      ...
      <Row>
        <Column className={classes.AboutExperience} small={12} medium={3} large={2}>
          <img className={classes.CompanyLogo} src={EvertzLogo} alt="Evertz Microsystems Limited"
        ...
        <Column className={classes.AboutExperience} small={12} medium={9} large={10}>
          ...
          <div data-aos="fade-up" data-aos-delay="100">
            <p data-aos="fade-up">As a Developer at Evertz I continually seek to improve in all aspects of my career. I am driven to better myself and the team by making meaningful contributions in any way I can. I always welcome constructive critisism and keep an open mind to alternative&nbsp;ideas.</p>
          </div>
        </Column>
      </Row>
      ...
      <Row>
        <Column className={classes.AboutExperience} small={12} medium={3} large={2}>
          <img className={classes.CompanyLogo} src={ThrillworksLogo} alt="Thrillworks Inc."
            data-aos="rotate-in-ltr" data-aos-delay="100" />
        </Column>
        ...
        <Column className={classes.AboutExperience} small={12} medium={9} large={10}>
          ...
          <ShowMoreLess>
            <p data-aos="fade-up" data-aos-delay="100">As a Developer at Thrillworks I worked on large scale web projects for a wide variety of enterprise clients. These clients included but were not limited to: President’s&nbsp;Choice <em>(PC&nbsp;Financial, PC&nbsp;Insiders, The&nbsp;Mobile&nbsp;Shop, PC&nbsp;Gas&nbsp;Bar)</em>, Motusbank, Meridian Credit&nbsp;Union, Tim&nbsp;Hortons, BlackBerry, Davies Ward Phillips &amp;&nbsp;Vineberg&nbsp;LLP, EdgePoint,&nbsp;Agrilight.</p>
            <p data-aos="fade-up" data-aos-delay="100">My Web Developer position at Thrillworks has given me experience&nbsp;with:</p>
      ...
      <Row>
        ...
        <Column className={classes.AboutExperience} small={12} medium={9} large={10}>
          <h3 className={classes.JobTitle} data-aos="fade-up" data-aos-delay="100">Web Production Specialist</h3>
          <h4 className="h5" data-aos="fade-up" data-aos-delay="100"><strong>3&nbsp;years, 3&nbsp;months</strong>
      ...
      <Row>
        <Column className={classes.AboutExperience} small={12} medium={3} large={2}>
          <img className={classes.CompanyLogo} src={RightChoiceLogo} alt="Right Choice Web Development"
            data-aos="rotate-in-ltr" data-aos-delay="100" />
        </Column>

        <Column className={classes.AboutExperience} small={12} medium={9} large={10}>
          <h3 className={classes.JobTitle} data-aos="fade-up" data-aos-delay="100">Co-Owner, Website Developer and Graphic&nbsp;Artist
          </h3>
          <h4 className="h5" data-aos="fade-up" data-aos-delay="100"><strong>9&nbsp;months</strong> &nbsp;|&nbsp;
      ...
      <Row>
        <Column className={classes.AboutExperience} small={12} medium={3} large={2}>
          <img className={classes.CompanyLogo} src={SlightlySocialLogo} alt="Slightly Social"
            data-aos="rotate-in-ltr" data-aos-delay="100" />
        </Column>

        <Column className={classes.AboutExperience} small={12} medium={9} large={10}>
          <h3 className={classes.JobTitle} data-aos="fade-up" data-aos-delay="100">3D Artist and Unity Developer</h3>
          <h4 className="h5" data-aos="fade-up" data-aos-delay="100"><strong>4&nbsp;months</strong> &nbsp;|&nbsp;
      ...
      <Row>
        <Column className={classes.Education} small={12}>
      ...
      <Row>
        <Column className={classes.AboutExperience} small={12} medium={3} large={2}>
          <img className={classes.CompanyLogo} src={GraduationImage} alt="Graduate" data-aos="rotate-in-ltr"
            data-aos-delay="100" />
        </Column>
      ...
      <Row>
        ...
        <Column className={`${classes.AboutExperience} no-bottom-space`} small={12} medium={9} large={10}>
