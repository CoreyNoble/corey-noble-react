      ...
      <React.Fragment>
        ...
        <div className={`${classes.ServicesPromotion} row`} data-equalizer="equalize-skill">
          {this.state.skillOverview.map(skill => {
            return (
              <div className={`${classes.ServicesPromotion} small-12 medium-12 large-4 columns ${skill.class}`} data-aos="fade-up" data-aos-delay="100" data-equalizer-watch="equalize-skill">
