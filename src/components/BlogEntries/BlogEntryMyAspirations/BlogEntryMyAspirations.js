  ...
  return (
    <React.Fragment>
      <Section background="blue">
        <Row>
          <Column small={12}>
            <h1 className="header-no-parallax">My Aspirations</h1>
          </Column>
        </Row>
      </Section>
      ...
      <Section background="white">
        <Row>
          <Column small={12}>
            ...
            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">Who I aspire to become</h2>
            ...
            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">My career goals</h2>
            ...
            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">Where do I see myself in 5 years?</h2>
            <p data-aos="fade-up" data-aos-delay="100">Full Front-End Developer, Extensive JS and PHP knowledge, Source Control Expert.</p>

            <hr data-aos="fade-up" data-aos-delay="100" />

            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">Where do I see myself in 10 years?</h2>
            <p data-aos="fade-up" data-aos-delay="100">JavaScript Guru, PHP know-it-all, Extensive Back-End knowledge.</p>

            <hr data-aos="fade-up" data-aos-delay="100" />

            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">Things I want to learn more about, eventually</h2>
            <p data-aos="fade-up" data-aos-delay="100">Quality Assurance Tools, Application Development.</p>

            <hr data-aos="fade-up" data-aos-delay="100" />

            <h2 className="h3" data-aos="fade-up" data-aos-delay="100">Where do I see myself in 25 years?</h2>
