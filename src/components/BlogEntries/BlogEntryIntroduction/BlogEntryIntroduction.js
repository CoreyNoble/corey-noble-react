  ...
  return (
    <React.Fragment>
      <Section background="blue">
            <Row>
              <Column small={12}>
                <h1 class="header-no-parallax">Blog Introduction</h1>
              </Column>
            </Row>
          </Section>
